...
/* harmony import */ var _modules_MyNotes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/MyNotes */ "./src/modules/MyNotes.js");
/* harmony import */ var _modules_Like__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/Like */ "./src/modules/Like.js");
...
const myNotes = new _modules_MyNotes__WEBPACK_IMPORTED_MODULE_6__["default"]();
const like = new _modules_Like__WEBPACK_IMPORTED_MODULE_7__["default"]();
      ...
      this.resultsDiv.html(`
			<div class="row">
				...
				<div class="one-third">
					...
					${results.program.length ? '<ul class="link-list min-list">' : `<p>No programs matches that search. <a href="${universityData.root_url}/programs">View all programs</a></p>`}
					${results.program.map(item => `<li><a href="${item.link}">${item.title}</a></li>`).join('')}
					${results.program.length ? '</ul>' : ''}
					<h2 class="search-overlay__section-title">Professors</h2>
					${results.professor.length ? '<ul class="professor-cards">' : `<p>No professors matches that search.</p>`}
				...
				<div class="one-third">
					...
					${results.campus.length ? '<ul class="link-list min-list">' : `<p>No campuses matches that search. <a href="${universityData.root_url}/campuses">View all campuses</a></p>`}
					${results.campus.map(item => `<li><a href="${item.link}">${item.title}</a></li>`).join('')}
					${results.campus.length ? '</ul>' : ''}
					<h2 class="search-overlay__section-title">Events</h2>
					${results.event.length ? '' : `<p>No events matches that search. <a href="${universityData.root_url}/events">View all events</a></p>`}
