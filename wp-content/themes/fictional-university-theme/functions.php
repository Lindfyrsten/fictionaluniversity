...
{
  wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyDjKUJFNa9PbA87rmdrg-n-4sF7h6hAVWY', NULL, '1.0', true);
...
{
  $api['key'] = 'AIzaSyDjKUJFNa9PbA87rmdrg-n-4sF7h6hAVWY';
  return $api;
}
